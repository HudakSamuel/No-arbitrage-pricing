...
public class PutAverageBinaryTree extends AveragePriceBinaryTree{

    public PutAverageBinaryTree(AssetTree assetTree, BigDecimal strikePrice) {
    ...
    protected void createValuesRecursive(Node current, Queue<BigDecimal> queue){
        if ((current.left == null) && (current.right == null)){
            ...
            BigDecimal leafValue = new BigDecimal(0).max(strikePrice.subtract(averagePathValue));
